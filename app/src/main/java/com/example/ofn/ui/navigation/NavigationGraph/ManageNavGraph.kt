...
import com.example.ofn.ui.navigation.MANAGE_GRAPH_ROUTE
...
fun NavGraphBuilder.manageNavGraph(
    ...
    navigation(
        startDestination = Screen.ManageProductsAndCategories.route,
        route = com.example.ofn.ui.navigation.MANAGE_GRAPH_ROUTE
    ){
